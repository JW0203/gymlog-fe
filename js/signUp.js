...
export function signUpForm() {
	document.getElementById('sign-up').addEventListener('click', function () {
		...
		// Clear any existing form in the content div
		while (contentDiv.firstChild) {
			contentDiv.removeChild(contentDiv.firstChild);
		}

		// Create a new div and add the signup form
      ...
      <div id="form-feedback" class="success-message"></div> <!-- Feedback section -->
    `;

		// Add the new div to the content area
		...
		form.addEventListener('submit', async function (event) {
			...
			try {
				...
				// Provide success feedback and keep the user on the page
				document.getElementById('form-feedback').textContent = '회원가입이 성공적으로 완료되었습니다!';
